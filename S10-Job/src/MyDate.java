...
public class MyDate {
    ...
    public int yearsBetween(MyDate givenDate) {
        return isBefore(givenDate) ? givenDate.getYear() - this.year + (31 * (givenDate.getMonth() - this.month) + givenDate.getDay() - this.day >= 0 ? 0 : -1) : equals(givenDate) ? 0 : givenDate.yearsBetween(this);
    }
